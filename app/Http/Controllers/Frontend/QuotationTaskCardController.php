...
use App\Http\Requests\Frontend\QuotationTaskCardStore;
use App\Http\Requests\Frontend\QuotationTaskCardUpdate;
...
class QuotationTaskCardController extends Controller
{
     ...
     *
     * @param  \App\Http\Requests\Frontend\QuotationTaskCardStore  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Http\Requests\Frontend\QuotationTaskCardUpdate  $request
     * @param  \App\Models\QuotationTaskCard  $quotationTaskCard
     * @return \Illuminate\Http\Response
     */
