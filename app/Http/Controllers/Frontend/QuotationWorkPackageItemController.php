...
use App\Http\Requests\Frontend\QuotationWorkPackageItemStore;
use App\Http\Requests\Frontend\QuotationWorkPackageItemUpdate;
...
class QuotationWorkPackageItemController extends Controller
{
     ...
     *
     * @param  \App\Http\Requests\Frontend\QuotationWorkPackageItemStore  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Http\Requests\Frontend\QuotationWorkPackageItemUpdate  $request
     * @param  \App\Models\QuotationWorkPackageItem  $quotationWorkPackageItem
     * @return \Illuminate\Http\Response
     */
