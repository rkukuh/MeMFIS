...
use App\Http\Requests\Frontend\OTRCertificationStore;
use App\Http\Requests\Frontend\OTRCertificationUpdate;
...
class OTRCertificationController extends Controller
{
     ...
     *
     * @param  \App\Http\Requests\Frontend\OTRCertificationStore  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \App\Http\Requests\Frontend\OTRCertificationUpdate  $request
     * @param  \App\Models\OTRCertification  $otrCertification
     * @return \Illuminate\Http\Response
     */
