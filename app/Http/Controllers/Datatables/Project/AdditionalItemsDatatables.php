...
class AdditionalItemsDatatables extends Controller
{
     /**
     ...
     * @return \Illuminate\Http\Response
     */
    public function selectedMaterial(Request $request, Project $project)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function selectedTool(Request $request,Project $project)
    {
        $defectcards = DefectCard::where('project_additional_id', $project->id)->get();
