...
namespace App\Http\Controllers\Datatables\WorkProgressReport;
...
class WorkProgressReportDatatables extends Controller
{
    /**
    ...
    {
        $projects = Project::with('aircraft','customer')->whereNull('parent_id')->get();
