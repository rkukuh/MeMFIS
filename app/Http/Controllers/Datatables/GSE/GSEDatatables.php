...
class GSEDatatables extends Controller
{
    /**
    ...
    {
        $GSE = GSE::with('storage')->get();
        foreach($GSE as $gse){
            // $gse->created_by .= User::find($gse->audits->first()->user_id)->name;
            // if($gse->approvals->toArray() == []){
            //     $conducted_by = "";
            //     $conducted_at = "";
            // }else{
