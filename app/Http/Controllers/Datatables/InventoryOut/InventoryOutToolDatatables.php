...
namespace App\Http\Controllers\Datatables\InventoryOut;
...
class InventoryOutToolDatatables extends Controller
{
    /**
    ...
    {
        $inventories = InventoryOut::with('storage', 'items', 'approvals')->get();
    ...
    public function filter(Request $request)
    {
        ...
        if (!empty($request->customer)) {
            $inventories->whereHas('customer', function ($query) use ($request) {
