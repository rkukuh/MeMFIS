...
class EmployeeSchoolDatatables extends Controller
{
    public function index(Employee $employee){
        $employeeSchool_data = EmployeeSchool::where('employee_id',$employee->id)->get();
        ...
        foreach($employeeSchool_data as $ed){
            $employeeSchool[$i] = [
                ...
                'graduated_at' => $ed->graduated_at
        ];
        $i++;
        }

        $data = $alldata = $employeeSchool;
