...
class GoodsReceivedDatatables extends Controller
{
    /**
    ...
    {
        $GoodsReceiveds = GoodsReceived::with('purchase_order','purchase_order.purchase_request','purchase_order.vendor')->get();
