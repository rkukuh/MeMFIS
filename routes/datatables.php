    ...
    Route::group([
        ...
        Route::name('workpackage.')->group(function () {
            ...
            Route::group([
                ...
                Route::get('/{workPackage}/materials', 'WorkPackageTaskCardRoutineSummaryDatatables@routineMaterial')->name('workpackage.taskcard.routine.material.summary');
                Route::get('/{workPackage}/tools', 'WorkPackageTaskCardRoutineSummaryDatatables@routineTool')->name('workpackage.taskcard.routine.tool.summary');
                ...
                Route::get('/{workPackage}/materials', 'WorkPackageTaskCardNonRoutineSummaryDatatables@nonRoutineMaterial')->name('workpackage.taskcard.nonroutine.material.summary');
                Route::get('/{workPackage}/tools', 'WorkPackageTaskCardNonRoutineSummaryDatatables@nonRoutineTool')->name('workpackage.taskcard.nonroutine.tool.summary');
