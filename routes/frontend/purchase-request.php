        ...
        Route::namespace('PurchaseRequest')->group(function () {
            ...
            Route::name('purchase-request.')->group(function () {
                Route::prefix('purchase-request')->group(function () {
                    ...
                    Route::get('/{purchaseRequest}/service/print', 'ServicePurchaseRequestController@print')->name('service.print');
                    Route::put('/{purchaseRequest}/project/approve', 'ProjectPurchaseRequestController@approve')->name('project.approve')->middleware('permission:scm_purchase-request_approve');
                    Route::put('/{purchaseRequest}/general/approve', 'GeneralPurchaseRequestController@approve')->name('general.approve')->middleware('permission:scm_purchase-request_approve');
                    Route::put('/{purchaseRequest}/service/approve', 'ServicePurchaseRequestController@approve')->name('service.approve')->middleware('permission:scm_purchase-request_approve');
