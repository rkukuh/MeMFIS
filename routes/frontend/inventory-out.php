        ...
        Route::namespace('InventoryOut')->group(function () {
            ...
            Route::prefix('inventory-out')->group(function () {
                ...
                Route::name('inventory-out-')->group(function () {
                    ...
                    Route::put('/material/{inventoryOut}/approve', 'MaterialInventoryOutController@approve')->name('material.approve')->middleware('permission:scm_inventory-out_approve');
                    ...
                    Route::put('/tool/{inventoryOut}/approve', 'ToolInventoryOutController@approve')->name('tool.approve')->middleware('permission:scm_inventory-out_approve');
                });
            });
        });
    });
