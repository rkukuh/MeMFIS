...
Route::name('frontend.')->group(function () {
    ...
    Route::group([
        ...
        Route::namespace('GoodsReceived')->group(function () {
            ...
            Route::put('goods-received/{goodsReceived}/approve', 'GoodsReceivedController@approve')->name('goods-received.approve')->middleware('permission:scm_grn_approve');

            Route::name('goods-received.')->group(function () {
                Route::prefix('goods-received')->group(function () {
                    Route::get('/{goodsReceived}/print', 'GoodsReceivedController@print')->name('print');
