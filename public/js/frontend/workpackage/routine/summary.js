let summaryroutine = {
    init: function () {
        ...
        $('.basic_materials_datatable').mDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
        ...
        $('.sip_tools_datatable').mDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
        ...
        $('.sip_materials_datatable').mDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
        ...
        $('.cpcp_tools_datatable').mDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
        ...
        $('.cpcp_materials_datatable').mDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
