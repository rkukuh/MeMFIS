    ...
    init: function () {
        $('.basic_datatable').mDatatable({
            ...
            },
            {
                ...
                filterable: !1,
                // template: function (t, e, i) {
                //     if(t.taskcard.pivot.sequence){
                //         return (
                //             t.taskcard.pivot.sequence+'<button data-toggle="modal" data-target="#taskcard_sequence" type="button" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill sequence" title="Sequence" data-sequence='+t.taskcard.pivot.sequence+' data-uuid=' +
                //             t.taskcard.uuid +
                //             '>\t\t\t\t\t\t\t<i class="la la-file-text-o"></i>\t\t\t\t\t\t</button>\t\t\t\t\t\t'
                //         );
                //     }else{
                //         return (
                //             '<button data-toggle="modal" data-target="#taskcard_sequence" type="button" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill sequence" title="Sequence" data-sequence='+t.taskcard.pivot.sequence+' data-uuid=' +
                //             t.taskcard.uuid +
                //             '>\t\t\t\t\t\t\t<i class="la la-file-text-o"></i>\t\t\t\t\t\t</button>\t\t\t\t\t\t'
                //         );
                //     }
            ...
            },
            {
                ...
                filterable: !1,
                template: function (t, e, i) {
                        // if(t.taskcard.pivot.is_mandatory == 1){
                        //     return (
                        ...
                        //     );
                        // }
                        // else if(t.taskcard.pivot.is_mandatory == 0){
                        //     return (
        ...
        $('.sip_datatable').mDatatable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    filterable: !1,
                    template: function (t) {
                        return '<button type="button" id="predecessor" name="predecessor" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill predecessor " data-tc_uuid="' + t.uuid + '" data-toggle="modal" data-target="#modal_predecessor"><i class="la la-plus-circle"></i>\t\t\t\t\t\t</button>'
                    }
                },
                {
                    field: 'successor',
                    ...
                    filterable: !1,
                    template: function (t) {
                        return '<button type="button" id="successor" name="successor" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill successor" data-tc_uuid="' + t.uuid + '" data-toggle="modal" data-target="#modal_successor"><i class="la la-plus-circle"></i>\t\t\t\t\t\t</button>'
                    }
                },
                {
                    field: 'mandatory',
