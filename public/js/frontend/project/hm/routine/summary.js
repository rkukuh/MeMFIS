        ...
        $('.tools_datatable').mDatatable({
            data: {
                ...
                source: {
                    read: {
                        method: 'GET',
                        url: '/datatables/project/'+project_uuid+'/workpackage/'+workPackage_uuid+'/type/'+type+'/tools',
                        map: function (raw) {
                            let dataSet = raw;
        ...
        $('.materials_datatable').mDatatable({
            data: {
                ...
                source: {
                    read: {
                        method: 'GET',
                        url: '/datatables/project/'+project_uuid+'/workpackage/'+workPackage_uuid+'/type/'+type+'/materials',
                        map: function (raw) {
                            let dataSet = raw;
