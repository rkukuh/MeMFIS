        ...
        columnDefs: [
            {
                ...
                render: function(a, e, t, n) {
                    return (
                        '\t\t\t\t\t\t\t<a class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill delete-predecessor" data-uuid="' +
                        t.uuid +
                        '" href="#"title="Delete"><i class="la la-trash"></i></a>\t\t\t\t\t\t\t'
                    );
                }
            }
        ]
        ...
        columnDefs: [
            {
                ...
                render: function(a, e, t, n) {
                    return (
                        '\t\t\t\t\t\t\t<a class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill delete-predecessor-instruction" data-uuid="' +
                        t.uuid +
                        '" href="#"title="Delete"><i class="la la-trash"></i></a>\t\t\t\t\t\t\t'
                    );
                }
...
$(".modal-footer").on("click", ".add-predecessor-instruction", function() {
    ...
    let order_predecessor = $(
        "input[name=order_predecessor_instruction]"
    ).val();
