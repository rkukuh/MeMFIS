        ...
        $('.purchase_request_datatable').mDatatable({
            data: {
                ...
                source: {
                    read: {
                        method: 'GET',
                        url: '/datatables/purchase-request/project',
            ...
            columns: [{
                    ...
                    filterable: !1,
                    template: function (t) {
                        return '<a href="/purchase-request-project/'+t.uuid+'">' + t.number + "</a>"
                    }
                },
                {
                    field: 'type.name',
                    ...
                    template: function (t, e, i) {
                        if(t.status == "Approved"){
                            ...
                            return (
                                ...
                                '</a>' +
                                '<a href="/purchase-request-project/' + t.uuid + '/edit" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill edit" title="Edit" data-uuid="' + t.uuid +'">' +
            ...
            .then(result => {
                if (result.value) {
                    $.ajax({
                        ...
                        type: 'PUT',
                        url: '/purchase-request/' +  purchase_request_uuid +'/project/approve',
            ...
            .then(result => {
                if (result.value) {
                    $.ajax({
                        ...
                        type: 'DELETE',
                        url: '/purchase-request-project/' + purchase_request_uuid + '',
                        success: function (data) {
