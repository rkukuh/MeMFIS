    ...
    init: function () {
        $('.item_datatable').mDatatable({
            data: {
                ...
                source: {
                    read: {
                        method: 'GET',
                        url: '/datatables/inventory-out/tool/' + inventoryout_uuid + '/items',
                        map: function (raw) {
                            let dataSet = raw;
        ...
        $(".modal-footer").on("click", ".add-item", function () {
            ...
            $.ajax({
                ...
                url: "/inventory-out/tool/" + inventoryout_uuid + "/item/" + tool,
                type: "POST",
                data: {
                    item_id: tool,
                    quantity: quantity,
                ...
                .then(result => {
                    if (result.value) {
                        $.ajax({
                            ...
                            type: 'DELETE',
                            url: '/inventory-out/tool/' + inventoryout_uuid + '/item/' + $(this).data('uuid'),
                            success: function (data) {
        ...
        $('.footer').on('click', '.update-inventory-out', function () {
            ...
            $.ajax({
                ...
                url: '/inventory-out/tool/' + inventoryout_uuid,
                type: 'PUT',
                data: {
                    ref_no: ref_no,
