                ...
                },
                {
                    ...
                    template: function (t, e, i) {
                        if(t.status == 'Approved'){
                            return (
                                '<a href="/item-request/material-request-jobcard/' + t.uuid +'/edit" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill edit" title="Edit" data-id="' + t.uuid +'">' +
                                ...
                                '</a>'+
                                '<a href="/item-request/material-request-jobcard/' + t.uuid +'/print" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill print" title="Print" data-id="' + t.uuid +'">' +
