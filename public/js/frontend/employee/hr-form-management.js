let HRForm = {
    init: function () {
        $('.m_datatable_hr_form').mDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
        ...
        let remove_hr_form = $('.m_datatable_hr_form').on('click', '.delete', function () {
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            let table = $('.m_datatable_hr_form').mDatatable();
        ...
        $('.m_datatable_employee_form').mDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
        ...
        let remove_employee_form = $('.m_datatable_employee_form').on('click', '.delete', function () {
            let triggerid = $(this).data('id');
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            let table = $('.m_datatable_employee_form').mDatatable();
