            ...
            data: {
                ...
                source: {
                    read: {
                        method: "GET",
                        url:
                            "/datatables/employee/" + uuid + "/employee-school",
            ...
            swal({
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        success: function(data) {
                            toastr.success(
                                "Employee education has been deleted.",
                                "Deleted",
                                {
                                    timeOut: 5000
                                }
