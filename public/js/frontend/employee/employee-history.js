let EmployeeHistory = {
    init: function () {
        $('.m_datatable_employee_hitory').mDatatable({
            data: {
                type: 'remote',
                source: {
                    read: {
        ...
        let remove_employee_hitory = $('.m_datatable_employee_hitory').on('click', '.delete', function () {
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            let table = $('.m_datatable_employee_hitory').mDatatable();
