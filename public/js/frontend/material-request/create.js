            ...
            columns: [{
                ...
                },
                {
                    ...
                    template: function (t, e, i) {
                        return (
                            '<button data-toggle="modal" data-target="#modal_material_request_edit" type="button" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill edit" title="Edit" data-instruction_uuid=' +
                            t.uuid +
