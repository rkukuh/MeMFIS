                        ...
                        if (t.quotation_type == "Quotation Project") {
                            ...
                            if (t.status == "Approved") {
                                ...
                                return (
                                    ...
                                    //     '<i class="la la-trash"></i>' +
                                    // '</a>'+
                                    '<a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill approve-additional" title="Approve Additional" data-id="' +
                                    t.uuid +
                                    '">' +
                                    '<i class="la la-check"></i>' +
                                    "</a>" +
