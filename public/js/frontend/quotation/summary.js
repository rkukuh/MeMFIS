            ...
            columns: [
                        ...
                        if (t.pivot) {
                            if (currency.id == 1) {
                                return (
                                    ...
                                    "<br>" +
                                    "- Manhours Price : " +
                                    t.total_manhours_with_performance_factor +
                                    " x " +
                                    IDRformatter.format(
                                        t.pivot.manhour_rate_amount
                                    ) +
                                    "<br>" +
                                    "- Facility Price : <br>" +
                                    "- Material & Tool Price : "
                            ...
                            if (currency.id == 1) {
                                return (
                                    ...
                                    " x " +
                                    IDRformatter.format(
                                        t.data_htcrr.manhour_rate_amount
                                    ) +
                                    "<br>" +
                                    "- Material & Tool Price : "
                                );
                        ...
                        if (a.pivot) {
                            if (currency.id == 1) {
                                return (
                                    "<br>" +
                                    IDRformatter.format(
                                        a.total_manhours_with_performance_factor *
                                            a.pivot.manhour_rate_amount
                                    ) +
                                    "<br>" +
                                    IDRformatter.format(
                                        a.facilities_price_amount
                                    ) +
                                    "<br>" +
                                    IDRformatter.format(a.mat_tool_price) +
                                    "<br>"
                                );
                            } else {
                                return (
                                    ...
                                    "<br>" +
                                    ForeignFormatter.format(a.mat_tool_price) +
                                    "<br>"
                                );
                            }
                                ...
                                return (
                                    ...
                                    IDRformatter.format(
                                        parseFloat(
                                            ...
                                            parseFloat(
                                                a.data_htcrr.manhour_rate_amount
                                            )
                                    ) +
                                    "<br>" +
                                    IDRformatter.format(a.mat_tool_price) +
                ...
                },
                {
                    ...
                    template: function(t, e, i) {
                        if( t.pivot && t.pivot.manhour_total ){
                          if( t.jobrequest_discount_value == null && t.jobrequest_discount_type == null ){
                            ...
                            if (t.jobrequest_discount_type == "discount-amount") {
                                ...
                                return (
                                    t.jobrequest_discount_percentage +
                                    "%" +
                                    '<button data-toggle="modal" data-target="#discount" type="button" href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill discount" title="Tool" data-uuid=' +
                                    t.uuid +
                                    '>\t\t\t\t\t\t\t<i class="la la-file-text-o"></i>\t\t\t\t\t\t</button>\t\t\t\t\t\t'
                ...
                },
                {
                    ...
                    template: function(t, e, i) {
                        ...
                        } else if (t.data_htcrr) { // from htcrr workpackage
                        ...
                        if (currency.id == 1) {
                            ...
                            $("#total_discount").html(
                                IDRformatter.format(TotalDiscount)
                            );
                            $("#total_discount").attr("value", TotalDiscount);

                            $("#grand_total").html(
                                IDRformatter.format(grandtotal)
                            );
                            $("#grand_total").attr("value", grandtotal);

                            $("#grand_total_rupiah").html(
                                IDRformatter.format(grandtotal)
                            );
                            ...
                            $("#sub_total").html(
                                ForeignFormatter.format(subtotal)
                            );
                            $("#sub_total").attr("value", subtotal);

                            $("#total_discount").html(
                                ForeignFormatter.format(TotalDiscount)
                            );
                            $("#total_discount").attr("value", TotalDiscount);

                            $("#grand_total").html(
                                ForeignFormatter.format(grandtotal)
                            );
                            $("#grand_total").attr("value", grandtotal);

                            $("#grand_total_rupiah").html(
                                IDRformatter.format(totalRupiah)
                            );
                        ...
                        if (currency.id == 1) {
                            return IDRformatter.format(total);
                        } else {
                            return ForeignFormatter.format(total);
                        }
                    }
                }
            ]
