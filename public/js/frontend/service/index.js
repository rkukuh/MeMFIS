        ...
        $('#item_datatable').DataTable({
            ...
            columns: [
                ...
                {data: '', name: '',sWidth:'10%','searchable': false ,render:function(data, type, row){
                    return (
                            '<a href="/service/' + row.uuid + '/edit" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill edit" title="Edit" data-id="' + row.uuid +'">' +
