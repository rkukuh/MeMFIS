let RefJobcard = {
    init: function () {
        $("#ref_jobcard_number_datatable").DataTable({
            ...
            columnDefs: [
                {
                    ...
                    render: function (a, e, t, n) {
                        return '<a class="btn btn-primary btn-sm m-btn--hover-brand select-jobcard" title="View" data-uuid="' + t.uuid + '" data-code="' + t.code + '" data-name="' + t.name + '">\n<span><i class="la la-edit"></i><span>Use</span></span></a>'
                    }
                },
        ...
        $('.dataTable').on('click', '.select-jobcard', function () {
            ...
            document.getElementById('jobcard_number').value = uuid;

            $('.search-jobcard').html(code + " - " + name);
            $('#modal_jobcard').modal('hide');
        });
    }
};
