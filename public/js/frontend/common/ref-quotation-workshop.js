let RefQuotationWorkshop = {
    init: function () {
        $("#ref_quotation_workshop_datatable").DataTable({
            ...
            columnDefs: [
                {
                    ...
                    render: function (a, e, t, n) {
                        return '<a class="btn btn-primary btn-sm m-btn--hover-brand select-quotation-workshop" title="View" data-uuid="' + t.uuid + '" data-code="' + t.code + '" data-name="' + t.name + '">\n<span><i class="la la-edit"></i><span>Use</span></span></a>'
                    }
                },
        ...
        $('.dataTable').on('click', '.select-quotation-workshop', function () {
