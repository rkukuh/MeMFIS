                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                                    @component('frontend.common.buttons.summary')
                                        ...
                                        @slot('href', route('frontend.quotation.summary.adsb', ['quotation' => $quotation->uuid, 'workPackage' => $workPackage->uuid]) )
                                    @endcomponent
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-6 order-1 order-xl-2 m--align-right">
                                        @component('frontend.common.buttons.summary')
                                            ...
                                            @slot('href', route('frontend.quotation.summary.cmrawl', ['quotation' => $quotation->uuid, 'workPackage' => $workPackage->uuid]) )
                                        @endcomponent
