        ...
        <div class="form-group m-form__group row">
            <div class="col-sm-3 col-md-3 col-lg-3">
                ...
                @component('frontend.common.input.datepicker')
                    @slot('id', 'daterange_material_transfer')
                    @slot('name', 'daterange_material_transfer')
                    @slot('id_error', 'daterange_material_transfer')
                @endcomponent
            </div>
            <div class="col-sm-3 col-md-3 col-lg-3">
                <label class="form-control-label">
...
<script src="{{ asset('js/frontend/functions/daterange/daterange-material-transfer.js')}}"></script>

<script src="{{ asset('js/frontend/material-transfer/filter.js') }}"></script>
