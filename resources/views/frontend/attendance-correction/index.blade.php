                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet m-portlet--mobile">
                        <div class="m-portlet__body">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                        @component('frontend.common.buttons.create')
                                            @slot('text', 'Attendance Correction')
                                            @slot('href', route('frontend.attendance-correction.create') )
                                        @endcomponent
                            ...
                            <div class="col-lg-12">
                                @include('frontend.attendance-correction.filter')
                            </div>
...
@push('footer-scripts')
    <script src="{{ asset('js/frontend/attendance-correction/index.js')}}"></script>
@endpush
