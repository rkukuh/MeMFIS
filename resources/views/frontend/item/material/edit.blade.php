                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet m-portlet--mobile">
                        <div class="m-portlet__body">
                            ...
                            @include('frontend.item.material.uom.modal')
                ...
                <div class="m-portlet">
                    ...
                    <div class="m-portlet m-portlet--mobile">
                        <div class="m-portlet__body">
                            ...
                            @include('frontend.item.material.storage.modal')
...
@push('footer-scripts')
    ...
    <script src="{{ asset('js/frontend/item/material/edit/item-unit.js') }}"></script>
    <script src="{{ asset('js/frontend/item/material/edit/item-storage.js') }}"></script>
