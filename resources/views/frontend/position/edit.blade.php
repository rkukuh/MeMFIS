                                                                ...
                                                                <div class="form-group m-form__group row">
                                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                                        <table class="table table-striped table-bordered second" widtd="100%" cellpadding="4">
                                                                            ...
                                                                            @if (sizeof($position->benefits) > 0)

                                                                                @foreach( $position->benefits as $benefit )
                                                                                    <tr>
                                                                                        <td valign="top"><b>{{ $benefit->name }}</b></td>
                                                                                        <td valign="top" align="center">{{ number_format( $benefit['pivot']->min ) }}</td>
                                                                                        <td valign="top" align="center">{{ number_format( $benefit['pivot']->max ) }}</td>
                                                                                    </tr>
                                                                                @endforeach
                                                                ...
                                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                                    <table class="table table-striped table-bordered second" widtd="100%" cellpadding="4">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td valign="top" align="center">{{ number_format( $history[$i]['data'][$j]['min'], 2) }}</td>
                                                                            <td valign="top" align="center">{{ number_format( $history[$i]['data'][$j]['max'], 2) }}</td>
                                                                        </tr>
                                                                        @endfor
