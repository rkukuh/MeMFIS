                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->created_at)
                                    @endcomponent
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <label class="form-control-label">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->jobcard->quotation->quotationable->aircraft->name)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->jobcard->quotation->quotationable->aircraft_register)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->jobcard->number)
                                    @endcomponent
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <label class="form-control-label">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->jobcard->quotation->quotationable->aircraft_sn)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->engineer_quantity)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text',  $taskrelease->helper_quantity)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text',  $taskrelease->estimation_manhour)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->complaint)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->description)
                                    @endcomponent
                                </div>
                            </div>
