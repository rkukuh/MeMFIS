                        ...
                        <div class="m-portlet__body">
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->jobcard->quotation->project->aircraft->name)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->jobcard->quotation->project->aircraft_register)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    ...
                                    @component('frontend.common.label.data-info')
                                        @slot('text', $taskrelease->jobcard->quotation->project->aircraft_sn)
                                    @endcomponent
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
