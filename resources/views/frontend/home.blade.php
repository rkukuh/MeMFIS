			...
			<div class="m-widget19__content">				
				<div class="m-widget19__header">
					<div class="m-widget19__user-img">							 
						<img class="m-widget19__img" src="assets/metronic/app/media/img//users/user1.jpg" alt="">  
					</div>
			...
			<div class="tab-pane active" id="m_widget5_tab1_content" aria-expanded="true">
				...
				<div class="m-widget5">
					<div class="m-widget5__item">
						<div class="m-widget5__content">
							<div class="m-widget5__pic"> 
								<img class="m-widget7__img" src="assets/metronic/app/media/img//products/product6.jpg" alt="">  
							</div>
					...
					<div class="m-widget5__item">
						<div class="m-widget5__content">
							<div class="m-widget5__pic"> 
								<img class="m-widget7__img" src="assets/metronic/app/media/img//products/product10.jpg" alt="">
							</div>
							<div class="m-widget5__section">
								<h4 class="m-widget5__title">
									Branding Mockup
					...
					<div class="m-widget5__item">
						<div class="m-widget5__content">
							<div class="m-widget5__pic"> 
								<img class="m-widget7__img" src="assets/metronic/app/media/img//products/product11.jpg" alt=""> 
							</div>
							<div class="m-widget5__section">
								<h4 class="m-widget5__title">
									Awesome Mobile App
