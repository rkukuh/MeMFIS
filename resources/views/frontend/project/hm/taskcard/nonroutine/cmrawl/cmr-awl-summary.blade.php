                ...
                <div class="m-portlet__body">
                    ...
                    <div class="table-responsive-xl text-center">
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    <td>@if( isset($otr["airframe"]) ) {{ $otr["airframe"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["powerplant"]) ) {{ $otr["powerplant"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["radio"]) ) {{ $otr["radio"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["electrical"]) ) {{ $otr["electrical"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["instrument"]) ) {{ $otr["instrument"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                </tr>
                            </tbody>
                        </table>
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    <td>@if( isset($otr["runup"]) ) {{ $otr["runup"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["repair"]) ) {{ $otr["repair"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["repainting"]) ) {{ $otr["repainting"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["cabin"]) ) {{ $otr["cabin"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["ndi-ndt"]) ) {{ $otr["ndi-ndt"] }} @else 0 taskcard(s) taskcard(s) @endif</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
