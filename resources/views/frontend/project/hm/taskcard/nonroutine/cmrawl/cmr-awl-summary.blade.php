                ...
                <div class="m-portlet__body">
                    ...
                    <div class="table-responsive-xl text-center">
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    <td>@if( isset($otr["airframe"]) ) {{ $otr["airframe"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["powerplant"]) ) {{ $otr["powerplant"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["radio"]) ) {{ $otr["radio"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["electrical"]) ) {{ $otr["electrical"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["instrument"]) ) {{ $otr["instrument"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                </tr>
                            </tbody>
                        </table>
                        <table class="table table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    <td>@if( isset($otr["runup"]) ) {{ $otr["runup"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["repair"]) ) {{ $otr["repair"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["repainting"]) ) {{ $otr["repainting"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["cabin"]) ) {{ $otr["cabin"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                    <td>@if( isset($otr["ndi-ndt"]) ) {{ $otr["ndi-ndt"] }} taskcard(s) @else 0 taskcard(s) taskcard(s) @endif</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                                ...
                                <div class="m-portlet m-portlet--mobile">
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="m-accordion__item-content">
                                            <div class="cmrawl_tools_datatable" id="scrolling_both"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="m-accordion__item-body collapse show" id="m_accordion_2_item_1_body" class=" " role="tabpanel" aria-labelledby="m_accordion_2_item_1_head" data-parent="#m_accordion_1">
                                ...
                                <div class="m-portlet m-portlet--mobile">
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="m-accordion__item-content">
                                            <div class="cmrawl_materials_datatable" id="scrolling_both"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
