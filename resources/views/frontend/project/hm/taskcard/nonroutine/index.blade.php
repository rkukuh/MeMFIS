...
<div class="m-portlet m-portlet--mobile">
    <div class="m-portlet__body">
        ...
        <div class="ht_crr_datatable" id="ht_crr_datatable"></div>
    </div>
</div>
<div class="m-portlet m-portlet--mobile">
    <div class="m-portlet__body">
        ...
        <div class="workshop_task_datatable" id="scrolling_both"></div>
    </div>
</div>

@push('footer-scripts')
    <script src="{{ asset('js/frontend/project/non-routine/create.js')}}"></script>
@endpush
