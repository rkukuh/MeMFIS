                ...
                <div class="m-portlet__body">
                    <div id="m_accordion_1" class="m-accordion m-accordion--default m-accordion--solid m-accordion--section m-accordion--padding-lg m-accordion--toggle-arrow" role="tablist">
                        ...
                        <div class="m-accordion__item ">
                            <div class="m-accordion__item-head collapsed" srole="tab" id="m_accordion_1_item_1_sip_summary" data-toggle="collapse" href="#m_accordion_1_item_1_body" aria-expanded="false">
                            ...
                            <div class="m-accordion__item-body collapse show" id="m_accordion_1_item_1_body" class=" " role="tabpanel" aria-labelledby="m_accordion_1_item_1_sip_summary" data-parent="#m_accordion_1">
                                ...
                                <div class="m-portlet m-portlet--mobile">
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="m-accordion__item-content">
                                            <div class="sip_tools_datatable" id="scrolling_both"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="m-accordion__item-body collapse show" id="m_accordion_2_item_1_body" class=" " role="tabpanel" aria-labelledby="m_accordion_2_item_1_head" data-parent="#m_accordion_1">
                                ...
                                <div class="m-portlet m-portlet--mobile">
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="m-accordion__item-content">
                                            <div class="sip_materials_datatable" id="scrolling_both"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
