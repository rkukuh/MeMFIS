<div class="modal fade" id="modal_email"  role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="TitleModalRepeat">
                    ...
                    <small id="email" class="m--font-focus"></small>
                </h5>
                        ...
                        <div class="m-portlet__body">
                                <div class="form-group m-form__group row ">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div id="m_repeater_email">
                                            <div class="" id="m_repeater_email">
