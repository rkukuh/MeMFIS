                                            ...
                                            <div class="m-portlet">
                                                ...
                                                <div class="m-portlet m-portlet--mobile">
                                                    <div class="m-portlet__body">
                                                        ...
                                                        @include('frontend.purchase-request.project.modal-material')
                                            ...
                                            <div class="m-portlet">
                                                ...
                                                <div class="m-portlet m-portlet--mobile">
                                                    <div class="m-portlet__body">
                                                        ...
                                                        @include('frontend.purchase-request.project.modal-tool')

                                                        <div class="tool_datatable" id="scrolling_both2"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
