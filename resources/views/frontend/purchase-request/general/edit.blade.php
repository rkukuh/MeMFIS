                                            ...
                                            <div class="m-portlet">
                                                ...
                                                <div class="m-portlet m-portlet--mobile">
                                                    <div class="m-portlet__body">
                                                        ...
                                                        @include('frontend.purchase-request.general.modal-material')
                                            ...
                                            <div class="m-portlet">
                                                ...
                                                <div class="m-portlet m-portlet--mobile">
                                                    <div class="m-portlet__body">
                                                        <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                                                                    @component('frontend.common.buttons.create-new')
                                                                        @slot('text', 'Tool')
                                                                        @slot('data_target', '#modal_general_tool')
                                                                    @endcomponent
                                                        ...
                                                        @include('frontend.purchase-request.general.modal-tool')
                                                        <div class="tool_datatable" id="scrolling_both"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
