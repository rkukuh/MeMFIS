    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-sm-3 col-md-3 col-lg-3 text-right" style="padding: 0;">
            @component('frontend.common.purchase-order.button-create')
                ...
                @slot('size', 'sm')
                @slot('icon', 'search')
                @slot('data_target', '#modal_jobcard')
...
@include('frontend.common.ref-jobcard-number.modal')

@push('footer-scripts')
    <script src="{{ asset('js/frontend/common/ref-jobcard-number.js') }}"></script>
