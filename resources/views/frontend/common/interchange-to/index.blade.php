<div style="background-color: {{ $background_color or 'beige' }};
    ...
    <div class="form-group m-form__group row">
        <div class="col-sm-8 col-md-8 col-lg-8">
                <div class="search-interchange-to" id="search-interchange-to"
        ...
        <div class="col-sm-3 col-md-3 col-lg-3 text-right" style="padding: 0;">
            @component('frontend.common.account-code.button-create')
                ...
                @slot('size', 'sm')
                @slot('icon', 'search')
                @slot('data_target', '#modal_interchange_to')
...
@include('frontend.common.interchange-to.modal')

@push('footer-scripts')
    <script src="{{ asset('js/frontend/common/interchange-to.js') }}"></script>
