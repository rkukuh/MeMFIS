...
@push('footer-scripts')
    ...
    <script src="{{ asset('js/frontend/service/edit/form-reset.js') }}"></script>
    <script src="{{ asset('js/frontend/service/edit.js') }}"></script>
    <script src="{{ asset('js/frontend/service/edit/item-unit.js') }}"></script>
    <script src="{{ asset('js/frontend/service/edit/item-storage.js') }}"></script>
