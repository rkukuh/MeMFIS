<div class="tab-pane" id="m_tabs_full_package_cost" role="tabpanel">
    ...
    <div class="form-group m-form__group row">
        <div class="col-sm-6 col-md-6 col-lg-6">
            <label class="form-control-label">
                Material(s) & Tool(s) Cost
            </label>

            @component('frontend.common.input.text')
                @slot('text', 'Material(s) & Tool(s) Cost')
                @slot('id', 'cost')
                @slot('name', 'cost')
                @slot('id_error', 'cost')
            @endcomponent
            ...
            <div class="flex">
                <div class="action-buttons">
                    @component('frontend.common.buttons.submit')
                        @slot('type','button')
                        @slot('id', 'approve-package-cost')
                        @slot('class', 'approve-package-cost')
                        @slot('text','Approve Full Package Cost')
                        @slot('color','primary')
                        @slot('icon','fa-check')
                    @endcomponent
                    ...
                    @component('frontend.common.buttons.submit')
                        @slot('type','button')
                        @slot('id', 'update-package-cost')
                        @slot('class', 'add-package-cost')
                        @slot('text','Update')
