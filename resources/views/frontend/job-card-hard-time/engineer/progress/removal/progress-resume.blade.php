                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                        <div class="m-portlet__body">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#" data-target="#m_tabs_1_1">Removal</a>
                                                </li>
                                                <li class="nav-item">
                                                    ...
                                                    <div class="form-group m-form__group row">
                                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                                            <div class="action-buttons d-flex flex-row-reverse">
                                                                @include('frontend.job-card-hard-time.engineer.progress.removal.modal.modal-close')
                                                                @component('frontend.common.buttons.close')
                                                                    @slot('data_target', '#modal_close')
                                                                    @slot('class', 'ml-2')
                                                                @endcomponent

                                                                @include('frontend.job-card-hard-time.engineer.progress.removal.modal.modal-pause')
