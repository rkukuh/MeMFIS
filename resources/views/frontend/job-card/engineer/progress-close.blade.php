                    ...
                    <div class="m-portlet  m-portlet--full-height ">
                        <div class="m-portlet__head">
                            <div class="m-portlet__head-caption">
                                <div class="m-portlet__head-title">
                                    <h3 class="m-portlet__head-text">
                                        @if(Auth::id() == $progresses_group->first()->progressed_by) Your Progress Timeline @else Job Card Progress Timeline @endif
                                        ( <div>{{ $progresses_group->first()->progressedBy->first_name }} {{ $progresses_group->first()->progressedBy->last_name }}</div> )
                                    </h3>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
                                        @foreach($progresses_group as $progresses)
                                            <div class="m-timeline-2__item">
                                                <span class="m-timeline-2__item-time">{{ date_format($progresses->created_at,"d/m/Y H:i") }} @if($progresses->note) {{ $progresses->note }} @endif</span>
