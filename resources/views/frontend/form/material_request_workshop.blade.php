...
<body>
    ...
    <header>
        ...
        <h1 style="top:-5px;left: 320px;position: absolute;color:white;text-align:center;">Material Request <br> <span style="font-size:12px">(From Jobcard)</span></h1>
        <div id="head">
            <table width="90%">
                <tr>
    ...
    <footer>
        ...
        <img src="./img/form/printoutmaterial-request/Footer.png" width="100%" alt="" >
    </footer>
        ...
        <div class="container">
            <table width="100%" cellpadding="2">
                <tr>
                    ...
                    <td valign="top" width="17%">Part Number</td>
                    <td valign="top" width="1%">:</td>
                ...
                <tr>
                    <td valign="top" width="14%">Workshop</td>
                    <td valign="top"width="1%">:</td>
                    <td valign="top" width="24%">Generated</td>
                    <td valign="top" width="17%">Serial No</td>
                    <td valign="top" width="1%">:</td>
                    <td valign="top" width="25%">Generated</td>
                </tr>
                <tr>
