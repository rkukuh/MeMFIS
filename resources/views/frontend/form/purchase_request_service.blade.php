            ...
            <table width="100%" cellpadding="6">
                ...
                @foreach($services as $service)
                    <tr>
                        ...
                        <td valign="top" align="center" width="21%">{{$service->service->code}}</td>
                        <td valign="top" width="31%">{{$service->service->name}} </th>
                        <td valign="top" align="center" width="8%">{{$service->quantity}}</td>
                        <td valign="top" align="center" width="8%">{{$service->unit->name}}</td>
                        <td valign="top" width="26%">{{$service->note}}</td>
                    </tr>
                @endforeach
            </table>
        </div>
