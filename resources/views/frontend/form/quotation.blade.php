            ...
            @endif
                <table width="100%" cellpadding="4">
                    ...
                    <tr>
                        ...
                        @endif
                        @if($jobRequest[$a]->pivot->discount_type ==  'amount')
                            <td width="17%" align="right" valign="top">{{$quotation->currency->symbol}}. {{ number_format($jobRequest[$a]->pivot->manhour_total * $jobRequest[$a]->pivot->manhour_rate + 138 - $jobRequest[$a]->pivot->discount_value) }}</td>
                        @elseif($jobRequest[$a]->pivot->discount_type == 'percentage')
                            <td width="17%" align="right" valign="top">{{$quotation->currency->symbol}}. {{ number_format($jobRequest[$a]->pivot->manhour_total * $jobRequest[$a]->pivot->manhour_rate + 138 - ((($jobRequest[$a]->pivot->manhour_total * $jobRequest[$a]->pivot->manhour_rate + 138)*$jobRequest[$a]->pivot->discount_value)/100)) }}</td>
                        @else
                            <td width="17%" align="right" valign="top">{{$quotation->currency->symbol}}. {{ number_format($jobRequest[$a]->pivot->manhour_total*$jobRequest[$a]->pivot->manhour_rate) }}</td>
                        @endif
                    </tr>
                    <tr>
                        <td width="8%" align="center" valign="top"></td>
                        ...
                        <td width="16%" align="center" valign="top">
                            @if($jobRequest[$a]->mat_tool_price)
                                {{$quotation->currency->symbol}}. {{$jobRequest[$a]->mat_tool_price}}
                            @else
                                -
                            @endif    
                        </td>
                        <td width="17%" align="center" valign="top">{{$jobRequest[$a]->total_manhours_with_performance_factor}}</td>
                        <td width="17%" align="right" valign="top"></td>
                    </tr>
                    <tr>
                        <td width="8%" align="center" valign="top"></td>
                        ...
                        <td width="16%" align="center" valign="top">
                            @if($jobRequest[$a]->facilities_price_amount)
                                {{$quotation->currency->symbol}}. {{$jobRequest[$a]->facilities_price_amount}}
                            @else
                                -
                            @endif
                        </td>
                ...
                <div class="body">
                    <table width="100%" cellpadding="4">
                        ...
                        <tr>
                            ...
                            @else
                            <td width="17%" align="right" valign="top">{{$quotation->currency->symbol}}. {{ number_format($jobRequest[$b]->pivot->manhour_total*$jobRequest[$b]->pivot->manhour_rate) }}</td>
                            @endif
                        </tr>
                        <tr>
                            <td width="8%" align="center" valign="top"></td>
