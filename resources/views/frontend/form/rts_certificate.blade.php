    ...
    <div id="content">
        ...
        <div class="kotak">
            ...
            <p style="text-align:left;padding:5px;">The work recorded above has been carried out, subject to exception/s
                itemized above, in accordance with requirements of Civil Aviation Safety Regulaton. For time being in
                force and in that respect the aircraft/equipment is approved for release to service.</p>
            <table width="100%">
                <tr width="100%">
            ...
            <p style="text-align:left;font-size: 14px;padding-left:5px;">For and behalf of PT. Merpati Maintanance
                Facility</p>
                ...
                <tr width="100%">
                    ...
                    <td width="82%" valign="top">
                        <div class="checkbox">
                            ...
                            <img src="./img/check.png" alt="" width="10"> <span style="margin-left:5px;">Indonesia DGCA
                                No :</span><span>145D-093</span>

                            @else
                            <img src="./img/check-box-empty.png" alt="" width="10"> <span
                                style="margin-left:5px;">Indonesia DGCA No :</span><span>145D-093</span>
