...
<body>
  ...
  <div id="header">
    <img src="./img/form/printoutjobcardsip/HeaderJobCardSIP.jpg" alt=""width="100%">
  </div>
  ...
  <div style="margin-top:14px;">
    <img src="./img/form/printoutjobcardsip/FooterJobCardRoutine.jpg" width="100%" alt="" srcset="">
  </div>
</body>
</html>