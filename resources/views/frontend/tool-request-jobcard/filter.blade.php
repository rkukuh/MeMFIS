        ...
        <div class="form-group m-form__group row">
            <div class="col-sm-3 col-md-3 col-lg-3">
                ...
                @component('frontend.common.input.datepicker')
                    @slot('id', 'daterange_tool_request')
                    @slot('name', 'daterange_tool_request')
                    @slot('id_error', 'daterange_tool_request')
                @endcomponent
...
<script src="{{ asset('js/frontend/functions/daterange/daterange-tool-request.js')}}"></script>
