<div class="modal fade" id="modal_employee_document" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="TitleModalEmployeeDocument">Employee Document</h5>
            ...
            <div class="modal-body">
                ...
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" id="EmployeeDocumentForm">
