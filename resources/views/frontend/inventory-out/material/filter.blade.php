        ...
        <div class="form-group m-form__group row">
            <div class="col-sm-3 col-md-3 col-lg-3">
                ...
                @component('frontend.common.input.datepicker')
                    @slot('id', 'daterange_inventory_in')
                    @slot('name', 'daterange_inventory_in')
                    @slot('id_error', 'daterange_inventory_in')
                @endcomponent
            </div>
            <div class="col-sm-3 col-md-3 col-lg-3">
                <label class="form-control-label">
...
<script src="{{ asset('js/frontend/functions/daterange/daterange-inventory-in.js')}}"></script>
