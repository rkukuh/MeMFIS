                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="form-group m-form__group row">
                                                <div class="col-sm-6 col-md-6 col-lg-6">
                                                    ...
                                                    @endcomponent
                                                    {{-- Generated editable dari checkout pulang(startnya harus melebihi dari jam pulangnya) --}}
                                                </div>
                                                <div class="col-sm-6 col-md-6 col-lg-6">
                                                    <label class="form-control-label">
                                                        End Time 
                                                    ...
                                                    @component('frontend.common.input.timepicker')
                                                        ...
                                                        @slot('class','m_timepicker_1 text-center')
                                                    @endcomponent
                                                    {{-- Generated editable dari checkout terakhir(boleh kurang tidak boleh lebih) --}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-6">
